"""
Django settings for risk_analyzer_2 project.
...
ROOT_URLCONF = 'risk_analyzer_2.urls'
...
WSGI_APPLICATION = 'risk_analyzer_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "risk_analyzer_2 API",
    "DESCRIPTION": "API documentation for risk_analyzer_2 App",
    "VERSION": "v1",
}
